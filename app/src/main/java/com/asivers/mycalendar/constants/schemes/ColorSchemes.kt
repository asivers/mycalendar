...
val LIGHT = ColorScheme(
    ...
    notSelectedYearInDropdown = Color(0xFF91AEE0), // unique
    notSelectedSettingInDropdown = Color(0xFF87A2D1), // unique
    settingsGearOnSettingsView = Color(0xFF91AEE0), // unique
